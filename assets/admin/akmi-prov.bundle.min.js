...
angular.module("RdmApp").controller("rekapCtrl",["$scope","$rootScope","common","DTOptionsBuilder","DTColumnBuilder","$http","$q","ApiServer","FileUploader",function(t,a,i,e,n,o,s,l,r){t.dtInstance={},t.currPg=0,console.log(a.userData),t.dtOptions=e.newOptions().withOption("searching",!0).withButtons([{extend:"copy",text:'<i class="fa fa-files-o"></i> Copy',titleAttr:"Copy"},{extend:"pdfHtml5",text:'<i class="fa fa-print" aria-hidden="true"></i> Print',download:"open",exportOptions:{columns:[0,1,2,3]},titleAttr:"Print",customize:function(t){a.customepdf(t,"Data Kabupaten","Pangkalan Data AKMI")}},{extend:"excelHtml5",text:'<i class="fa fa-file-text-o"></i> Excel',exportOptions:{columns:[0,2,3]},titleAttr:"Excel"}]).withOption("drawCallback",(function(a){if(t.currPg=0,a.aoData.length>0){var i=this.api().page.info();console.log(i),t.currPg=i.start}})).withOption("language",{paginate:{first:"<i class='fa fa-fast-backward'></i>",previous:"<i class='fa fa-step-backward'></i>",next:"<i class='fa fa-step-forward'></i>",last:"<i class='fa fa-fast-forward'></i>|"}}).withDOM("lBfrtip").withOption("responsive",!0).withDisplayLength(10).withOption("lengthMenu",[[10,25,50,100,-1],[10,25,50,100,"All"]]).withOption("stateSave",!0).withOption("paging",!0).withOption("processing",!0).withOption("aaSorting",[0,"asc"]).withPaginationType("full_numbers"),t.reloadTable=function(){$(".table-responsive").block({message:'<i class="fa fa-spinner fa-spin"></i>'}),l.get("admin/rekap/data",(function(t){$.unblockUI({}),$(".table-responsive").unblock({}),a.datarekap={},a.datarekap=t.data}))},t.reloadTable()}]);
