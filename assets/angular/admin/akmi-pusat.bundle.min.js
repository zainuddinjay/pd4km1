...
angular.module("RdmApp").config(["$stateProvider","$urlRouterProvider",function(a,e){e.otherwise("/dashboard"),a.state("dashboard",{url:"/dashboard",templateUrl:"default.html",data:{pageTitle:"Beranda Elearning",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"DashboardCtrl"}).state("lembaga",{url:"/lembaga",templateUrl:"lembaga.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"lembagaCtrl"}).state("carilembaga",{url:"/carilembaga",templateUrl:"admin/pages/carilembaga"+versionApp,data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"carilembagaCtrl",resolve:{deps:["$ocLazyLoad",function(a){return a.load({name:"RdmApp",insertBefore:"#ng_load_plugins_before",files:["assets/angular/js/controller/admin/carilembagaCtrl.js"+versionApp]})}]}}).state("pelaksanaan",{url:"/pelaksanaan",templateUrl:"pelaksanaan.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"pelaksanaCtrl"}).state("datasiswa",{url:"/datasiswa",templateUrl:"datasiswa.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"datasiswaCtrl"}).state("adminprov",{url:"/adminprov",templateUrl:"adminprov.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"adminprovCtrl"}).state("timeline",{url:"/timeline",templateUrl:"timeline.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"timelineCtrl"}).state("adminkab",{url:"/adminkab",templateUrl:"adminkab.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"adminkabCtrl"}).state("provinsi",{url:"/provinsi",templateUrl:"provinsi.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"provinsiCtrl"}).state("kabupaten",{url:"/kabupaten",templateUrl:"kabupaten.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"kabupatenCtrl"}).state("kecamatan",{url:"/kecamatan",templateUrl:"kecamatan.html",data:{pageTitle:"Kelas Siswa",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"kecamatanCtrl"}).state("kelengkapan",{url:"/kelengkapan",templateUrl:"kelengkapan.html",data:{pageTitle:"Chek kelengkapan",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"kelengkapanCtrl"}).state("pengaturan",{url:"/pengaturan",templateUrl:"pengaturan.html",data:{pageTitle:"Pengaturan Aplikasi",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"pengaturanCtrl"}).state("usernadrasah",{url:"/usernadrasah",templateUrl:"usernadrasah.html",data:{pageTitle:"Pengaturan Aplikasi",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"usernadrasahCtrl"}).state("rekap",{url:"/rekap",templateUrl:"rekap.html",data:{pageTitle:"Pengaturan Aplikasi",pageThumb:"Home",pageSubThumb:{0:"Login"}},controller:"rekapCtrl"})}]);
